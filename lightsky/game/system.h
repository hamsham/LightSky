...
class system {
    private:
         ...
         * 
         * @param evt
         * A constant reference to the event which was generated by SDL;
         * 
         * @param pState
         * A pionter to a game state which will be sent hardware events.
         */
        void passHardwareEvents(const SDL_Event& evt, gameState* const pState);
