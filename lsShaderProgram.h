...
class shaderProgram {
    ...
    public:
         ...
         */
        inline bool attachShaders(
            const vertexShader& vs,
            const fragmentShader& fs
        ) {
            return attachShaders(vs.objectId, fs.objectId);
        }
        ...
        inline bool attachShaders(
            ...
            return attachShaders(vs.objectId, gs.objectId, fs.objectId);
        }
        
        /**
         * Attach a shader object to a program
         */
        bool attachShaders(GLuint vertId, GLuint fragId);
        
        /**
         * Attach a shader object to a program
         */
        bool attachShaders(GLuint vertId, GLuint geomId, GLuint fragId);
