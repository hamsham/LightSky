...
class lsDrawModel final {
    ...
    public:
        ...
        lsDrawModel& operator=(const lsDrawModel&);
         ...
         */
        inline const lsMesh* getMesh() const {
            return pMesh;
        }
         ...
         */
        bool setMesh(const lsMesh* const);
         ...
         */
        inline const lsTexture* getTexture() const {
            return pTexture;
        }
         ...
         */
        void setTexture(const lsTexture* const);
...
inline void lsDrawModel::draw() const {
    const ls_draw_t dm = pMesh->getDrawMode();
