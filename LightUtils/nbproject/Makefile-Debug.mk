...
${OBJECTDIR}/_ext/528976753/assert.o: ../lightsky/utils/src/assert.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/assert.o ../lightsky/utils/src/assert.cpp

${OBJECTDIR}/_ext/528976753/dataResource.o: ../lightsky/utils/src/dataResource.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/528976753
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/dataResource.o ../lightsky/utils/src/dataResource.cpp

${OBJECTDIR}/_ext/528976753/randomNum.o: ../lightsky/utils/src/randomNum.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/528976753
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/randomNum.o ../lightsky/utils/src/randomNum.cpp

${OBJECTDIR}/_ext/528976753/resource.o: ../lightsky/utils/src/resource.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/528976753
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/resource.o ../lightsky/utils/src/resource.cpp

${OBJECTDIR}/_ext/528976753/string_utils.o: ../lightsky/utils/src/string_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/528976753
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/string_utils.o ../lightsky/utils/src/string_utils.cpp

${OBJECTDIR}/_ext/528976753/tuple.o: ../lightsky/utils/src/tuple.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/528976753
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/tuple.o ../lightsky/utils/src/tuple.cpp
...
${TESTDIR}/tests/pointer_test.o: tests/pointer_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/pointer_test.o tests/pointer_test.cpp
...
${OBJECTDIR}/_ext/528976753/assert_nomain.o: ${OBJECTDIR}/_ext/528976753/assert.o ../lightsky/utils/src/assert.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/assert_nomain.o ../lightsky/utils/src/assert.cpp;\
	else  \
...
${OBJECTDIR}/_ext/528976753/dataResource_nomain.o: ${OBJECTDIR}/_ext/528976753/dataResource.o ../lightsky/utils/src/dataResource.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/dataResource_nomain.o ../lightsky/utils/src/dataResource.cpp;\
	else  \
...
${OBJECTDIR}/_ext/528976753/randomNum_nomain.o: ${OBJECTDIR}/_ext/528976753/randomNum.o ../lightsky/utils/src/randomNum.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/randomNum_nomain.o ../lightsky/utils/src/randomNum.cpp;\
	else  \
...
${OBJECTDIR}/_ext/528976753/resource_nomain.o: ${OBJECTDIR}/_ext/528976753/resource.o ../lightsky/utils/src/resource.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/resource_nomain.o ../lightsky/utils/src/resource.cpp;\
	else  \
...
${OBJECTDIR}/_ext/528976753/string_utils_nomain.o: ${OBJECTDIR}/_ext/528976753/string_utils.o ../lightsky/utils/src/string_utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/string_utils_nomain.o ../lightsky/utils/src/string_utils.cpp;\
	else  \
...
${OBJECTDIR}/_ext/528976753/tuple_nomain.o: ${OBJECTDIR}/_ext/528976753/tuple.o ../lightsky/utils/src/tuple.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DLS_DEBUG -I.. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/528976753/tuple_nomain.o ../lightsky/utils/src/tuple.cpp;\
	else  \
