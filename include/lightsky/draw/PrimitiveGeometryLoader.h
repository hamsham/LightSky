 ...
 * @param ibo
 * A reference to an index buffer object which will be used to reference the
 * vertices in "vbo" during a render pass.
 * 
 * @param numPoints
 * The number of points that the polygon should contain. This number must be
 * greater than, or equal to, 3.
 * 
 * @return The number of indices in "ibo" which are required to render the set
 * of vertices contained within the "vbo" parameter.
-------------------------------------*/
unsigned load_polygon_geometry(
    const common_vertex_t vertTypes,
    BufferObject& vbo,
    BufferObject& ibo,
 ...
 * of vertices contained within the "vbo" parameter.
-------------------------------------*/
inline unsigned load_triangle_geometry(
    const common_vertex_t vertTypes,
    BufferObject& vbo,
    BufferObject& ibo
) {
    return load_polygon_geometry(vertTypes, vbo, ibo, 3);
}
 ...
 * 
 * @param numPoints
 * The number of points that the circle should contain. This number must be
 * greater than, or equal to, 3.
 * 
 * @return The number of indices in "ibo" which are required to render the set
 * of vertices contained within the "vbo" parameter.
-------------------------------------*/
unsigned load_circle_geometry(
    const common_vertex_t vertTypes,
    BufferObject& vbo,
    BufferObject& ibo,
...
/**------------------------------------
 * @brief Load a set of vertices representing a cube.
 * 
 * @param vertTypes
 * A bitmask, containing flags from the common_vertex_t enumeration which will
 * be used to determine the types of vertices to load into the input vertex
 ...
 * of vertices contained within the "vbo" parameter.
-------------------------------------*/
unsigned load_cylinder_geometry(
    const common_vertex_t vertTypes,
    BufferObject& vbo,
    BufferObject& ibo,
    unsigned numSides = 2
...
/**------------------------------------
 * @brief Load a set of vertices representing a cone.
 * 
 * @param vertTypes
 * A bitmask, containing flags from the common_vertex_t enumeration which will
 * be used to determine the types of vertices to load into the input vertex
 ...
 * 
 * @param numSides
 * The number of sides that the polygon should contain. This number must be
 * greater than, or equal to, 2.
 * 
 * @return The number of indices in "ibo" which are required to render the set
 * of vertices contained within the "vbo" parameter.
-------------------------------------*/
unsigned load_cone_geometry(
    const common_vertex_t vertTypes,
    BufferObject& vbo,
    BufferObject& ibo,
    unsigned numSides = 2
...
/**------------------------------------
 * @brief Load a set of vertices representing a sphere.
 * 
 * @param vertTypes
 * A bitmask, containing flags from the common_vertex_t enumeration which will
 * be used to determine the types of vertices to load into the input vertex
 ...
 * 
 * @param resolution
 * The number of longitude and latitude lines that the sphere should contain.
 * This number must be greater than, or equal to, 4.
 * 
 * @return The number of indices in "ibo" which are required to render the set
 * of vertices contained within the "vbo" parameter.
-------------------------------------*/
unsigned load_sphere_geometry(
    const common_vertex_t vertTypes,
    BufferObject& vbo,
    BufferObject& ibo,
    unsigned resolution
