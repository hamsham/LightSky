 ...
 * Keyboard States
******************************************************************************/
void lightState::updateKeyStates(float dt) {
 ...
 * Running state
******************************************************************************/
void lightState::onRun(float dt) {
    updateKeyStates(dt);
 ...
 * Pausing state
******************************************************************************/
void lightState::onPause(float dt) {
    updateKeyStates(dt);
