...
${OBJECTDIR}/_ext/1644805454/bufferObject.o: ../lightsky/draw/src/bufferObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1644805454
	${RM} "$@.d"
	$(COMPILE.cc) -g -DLS_DEBUG -I.. -I../../../../../../Qt/Tools/mingw482_32/i686-w64-mingw32/include/freetype2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1644805454/bufferObject.o ../lightsky/draw/src/bufferObject.cpp
